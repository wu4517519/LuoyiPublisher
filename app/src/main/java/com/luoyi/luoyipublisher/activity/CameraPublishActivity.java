...
/* video软编码profile设置
    ...
    final private String baseURL = "rtmp://192.168.80.130/LuoyiLive/1";
...
/**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "快照存储路径: " + imageSavePath);
        ...
        pushTypeSelector.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                pushType = position;
                Log.e(TAG, "[推送类型]Currently choosing: " + types[position] + ", pushType: " + pushType);
            }
        ...
        watermarkSelctor.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.e(TAG, "[水印类型]Currently choosing: " + watermarks[position] + ", watemarkType: " + watemarkType);
            }
        ...
        resolutionSelector.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.e(TAG, "[推送分辨率]Currently choosing: " + resolutionSel[position]);
        ...
        swVideoEncoderProfileSelector.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.e(TAG, "[VideoProfile]Currently choosing: " + profileSel[position]);
        ...
        recorderSelector.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.e(TAG, "Currently choosing: " + recoderSel[position]);
        ...
        swVideoEncoderSpeedSelector.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Log.e(TAG, "Currently speed choosing: " + video_encoder_speed_Sel[position]);

                sw_video_encoder_speed = 6 - position;

                Log.e(TAG, "Choose speed=" + sw_video_encoder_speed);
            }
...
/**
    ...
    void SwitchResolution(int position) {
        Log.e(TAG, "Current Resolution position: " + position);
...
/**
    ...
    class ButtonStartListener implements OnClickListener {
        public void onClick(View v) {
            ...
            if (libPublisher != null) {
                ...
                Log.e(TAG, "videoWidth: " + videoWidth + " videoHight: " + videoHight + " pushType:" + pushType);
    ...
    class ButtonStartPushListener implements OnClickListener {
        public void onClick(View v) {
            ...
            mFrameProcess = new FrameProcess(videoWidth, videoHight, rs, yuvToRgbIntrinsic);
    ...
    class ButtonStartRecorderListener implements OnClickListener {
        public void onClick(View v) {
            ...
            Log.e(TAG, "onClick start recorder..");
...
/**
    ...
    private void stopRecorder() {
        if (!isPushing) {
            if (audioRecord_ != null) {
                Log.e(TAG, "stopRecorder, call audioRecord_.StopRecording..");
                audioRecord_.StopRecording();
                audioRecord_ = null;
            }
        }
    ...
    protected void onDestroy() {
        ...
        if (isStart) {
            isStart = false;
            StopPublish();
            Log.e(TAG, "onDestroy StopPublish");
        }

        if (isPushing || isRecording) {
            if (audioRecord_ != null) {
                Log.e(TAG, "surfaceDestroyed, call StopRecording..");
                audioRecord_.StopRecording();
                audioRecord_ = null;
            }
...
/*it will call when surfaceChanged*//*
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        try {
            ...
            Log.e(TAG, "onConfigurationChanged, start:" + isStart);
...
/**
    ...
    public static File getOwnCacheDirectory(Context context, String cacheDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && hasExternalStoragePermission(context)) {
            ...
            Log.e(TAG, "appCacheDir: " + appCacheDir);
        }
